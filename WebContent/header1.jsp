		...
		<div class="navbar-header">
			...
			<c:if test="${!empty user}">
				<%-- <div style="margin-top: 15px; margin-left: -20px;">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;欢迎您：<span
						style="color: red; font-weight: bold">${sessionScope.user.name}</span>
					<img src="<%=basePath%>/img/gerenzx.png"
						style="margin-left: 1000px" />&nbsp;&nbsp; <a
						href="<%=basePath%>/personalCenter.jsp" style="color: black">个人中心</a>
				</div> --%>
				<div style="margin-top: 15px;">
					<a target="_parent" href="<%=basePath%>/index.jsp"><img
						src="<%=basePath%>/img/shouye.png" width="30px" height="30px" /></a>
					&nbsp;&nbsp;&nbsp;&nbsp;欢迎您：<span
						style="color: red; font-weight: bold">${sessionScope.user.name}</span>
					<img src="<%=basePath%>/img/gerenzx.png" style="margin-left: 50px;" />&nbsp;&nbsp;
